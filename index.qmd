...
1. It has positive contemporaneous effect on stock prices.
2. It has no contemporaneous effect on productivity.
3. It is negative in 2020 Q1.
...
# need to subtract the number of lags
sign_narrative    = matrix(c(1, -1, 1, 1, covid_index - 4, 3), ncol = 6)
...
```{r au-sig-irf}
#| fig-cap: "Australian IRF with additional narrative restriction (median and 68% highest density interval)"
